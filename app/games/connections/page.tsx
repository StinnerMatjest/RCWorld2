  ...
  if (error || groups.length !== 4) {
    ...
    return (
      <div className="min-h-screen bg-[#0f172a] p-6 flex flex-col items-center justify-center text-center">
        <h1 className="text-3xl sm:text-4xl font-black tracking-tighter text-white mb-6 uppercase italic">
          Connections
        </h1>
        <div className="max-w-md w-full p-6 sm:p-8 bg-slate-800 rounded-3xl shadow-sm border border-slate-700">
          ...
          {isAdminMode && (
            <div className="mt-8">
              <Link
                ...
                className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold uppercase tracking-widest rounded-full transition-all hover:scale-105 shadow-md"
              >
                ⚙️ Manage Categories
              </Link>
            </div>
