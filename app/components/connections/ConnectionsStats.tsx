  ...
  return (
    <div className="w-full max-w-xl animate-reveal">
      <div className="rounded-3xl p-[1px] bg-gradient-to-r from-blue-500 via-indigo-500 to-fuchsia-500 shadow-xl">
        <div className=" bg-slate-900 rounded-[calc(1.5rem-1px)] p-6 sm:p-8 text-center">
          ...
          <div className="grid grid-cols-4 gap-4 mb-8">
            {items.map((s) => (
              <div
                key={s.label}
                className="rounded-2xl bg-slate-800/70 p-4 shadow-sm"
              >
          ...
          <div className="text-left rounded-2xl bg-gradient-to-r from-slate-800/60 to-slate-800/30 p-5 sm:p-6">
              ...
              {stats.guessDistribution.map((count, i) => {
                ...
                return (
                  <div key={i} className="flex items-center gap-3 text-sm font-bold">
                    <span className="w-4 text-slate-400 text-center">
                      {label}
                    </span>
                    <div
