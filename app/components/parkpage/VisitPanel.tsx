  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className={`w-full flex flex-col items-center px-2 py-2 rounded-xl text-center transition-colors ${hasMultiple ? "hover:bg-gray-100 dark:hover:bg-gray-800/50 cursor-pointer" : "cursor-default"
          }`}
      >
        <div className="flex items-center gap-1.5">
          ...
          <div className="flex items-baseline gap-0.5">
            <span className={`text-4xl font-black tabular-nums leading-none ${getRatingColor(active.overall)}`}>
              {active.overall}
            </span>
          ...
          {hasMultiple && (
            <svg
              className={`w-3 h-3 flex-shrink-0 text-gray-400 dark:text-gray-600 transition-transform duration-200 ${open ? "rotate-180" : ""}`}
        ...
        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 leading-tight truncate mt-0.5">
