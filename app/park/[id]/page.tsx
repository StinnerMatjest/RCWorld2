...
interface ParkPageProps {
  params: { id: string }; // The dynamic ID parameter from the URL
}
...
export default async function ParkPage({ params }: ParkPageProps) {
  ...
  return (
    <div className="park-details">
      ...
      <div>
        <p><strong>Location:</strong> {park?.city}, {park?.country}, {park?.continent}</p>
        <p><strong>Details:</strong> More info about the park here...</p>
        <MainPageButton/>
      </div>
    </div>
  );
